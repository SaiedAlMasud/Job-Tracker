    ...
    for(let job of interviewed){
        ...
        div.innerHTML = `<div class="card-body w-full">
                    ...
                    <div class="not-applied mt-2">
                        <span class="not-applied badge bg-[#EEF4FF] w-36 p-4 text-[16px] font-medium">NOT APPLIED</span>
                        <button class="interview-show-btn btn btn-outline btn-success hidden">INTERVIEW</button>
                        <button class="rejected-show-btn btn btn-outline btn-error hidden">REJECTED</button>
                    </div>
